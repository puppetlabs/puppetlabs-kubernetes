...
def replace_apps_v1_namespaced_controller_revision(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/apps/v1/namespaces/%{namespace}/controllerrevisions/%{name}" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_apps_v1_namespaced_controller_revision(params)
