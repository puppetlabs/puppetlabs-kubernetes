...
def create_authorization_v1_namespaced_local_subject_access_review(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/authorization.k8s.io/v1/namespaces/%{namespace}/localsubjectaccessreviews" % path_params
...
def task
  ...
  params = $stdin.read
  result = create_authorization_v1_namespaced_local_subject_access_review(params)
