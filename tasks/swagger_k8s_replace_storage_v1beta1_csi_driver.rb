...
def replace_storage_v1beta1_csi_driver(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/storage.k8s.io/v1beta1/csidrivers/%{name}" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_storage_v1beta1_csi_driver(params)
