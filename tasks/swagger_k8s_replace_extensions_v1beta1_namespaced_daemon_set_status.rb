...
def replace_extensions_v1beta1_namespaced_daemon_set_status(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/extensions/v1beta1/namespaces/%{namespace}/daemonsets/%{name}/status" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_extensions_v1beta1_namespaced_daemon_set_status(params)
