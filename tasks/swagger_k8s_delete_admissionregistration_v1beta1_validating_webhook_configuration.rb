...
def delete_admissionregistration_v1beta1_validating_webhook_configuration(*args)
  header_params = {}
...
def task
  ...
  params = $stdin.read
  result = delete_admissionregistration_v1beta1_validating_webhook_configuration(params)
