...
def replace_apiregistration_v1_api_service_status(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/apiregistration.k8s.io/v1/apiservices/%{name}/status" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_apiregistration_v1_api_service_status(params)
