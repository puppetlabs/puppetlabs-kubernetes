...
def replace_policy_v1beta1_pod_security_policy(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/policy/v1beta1/podsecuritypolicies/%{name}" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_policy_v1beta1_pod_security_policy(params)
