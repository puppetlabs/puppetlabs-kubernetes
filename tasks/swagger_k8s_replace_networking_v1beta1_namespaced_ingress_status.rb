...
def replace_networking_v1beta1_namespaced_ingress_status(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/networking.k8s.io/v1beta1/namespaces/%{namespace}/ingresses/%{name}/status" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_networking_v1beta1_namespaced_ingress_status(params)
