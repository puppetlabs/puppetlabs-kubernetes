...
def delete_networking_v1beta1_collection_namespaced_ingress(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/networking.k8s.io/v1beta1/namespaces/%{namespace}/ingresses" % path_params
...
def task
  ...
  params = $stdin.read
  result = delete_networking_v1beta1_collection_namespaced_ingress(params)
