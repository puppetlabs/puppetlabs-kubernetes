...
def get_coordination_v1beta1_api_resources(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/coordination.k8s.io/v1beta1/" % path_params
...
def task
  ...
  params = $stdin.read
  result = get_coordination_v1beta1_api_resources(params)
