...
def delete_core_v1_collection_namespaced_persistent_volume_claim(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/api/v1/namespaces/%{namespace}/persistentvolumeclaims" % path_params
...
def task
  ...
  params = $stdin.read
  result = delete_core_v1_collection_namespaced_persistent_volume_claim(params)
