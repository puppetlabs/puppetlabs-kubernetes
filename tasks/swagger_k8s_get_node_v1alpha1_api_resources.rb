...
def get_node_v1alpha1_api_resources(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/node.k8s.io/v1alpha1/" % path_params
...
def task
  ...
  params = $stdin.read
  result = get_node_v1alpha1_api_resources(params)
