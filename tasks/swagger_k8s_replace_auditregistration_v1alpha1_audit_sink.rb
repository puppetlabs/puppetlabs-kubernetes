...
def replace_auditregistration_v1alpha1_audit_sink(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/auditregistration.k8s.io/v1alpha1/auditsinks/%{name}" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_auditregistration_v1alpha1_audit_sink(params)
