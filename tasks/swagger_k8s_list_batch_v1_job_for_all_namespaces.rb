...
def list_batch_v1_job_for_all_namespaces(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/batch/v1/jobs" % path_params
...
def task
  ...
  params = $stdin.read
  result = list_batch_v1_job_for_all_namespaces(params)
