...
def delete_scheduling_v1beta1_collection_priority_class(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/scheduling.k8s.io/v1beta1/priorityclasses" % path_params
...
def task
  ...
  params = $stdin.read
  result = delete_scheduling_v1beta1_collection_priority_class(params)
