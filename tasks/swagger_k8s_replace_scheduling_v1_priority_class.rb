...
def replace_scheduling_v1_priority_class(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/scheduling.k8s.io/v1/priorityclasses/%{name}" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_scheduling_v1_priority_class(params)
