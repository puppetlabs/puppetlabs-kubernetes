...
def create_admissionregistration_v1beta1_validating_webhook_configuration(*args)
  header_params = {}
...
def task
  ...
  params = $stdin.read
  result = create_admissionregistration_v1beta1_validating_webhook_configuration(params)
