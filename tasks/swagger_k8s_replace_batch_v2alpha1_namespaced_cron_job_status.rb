...
def replace_batch_v2alpha1_namespaced_cron_job_status(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/batch/v2alpha1/namespaces/%{namespace}/cronjobs/%{name}/status" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_batch_v2alpha1_namespaced_cron_job_status(params)
