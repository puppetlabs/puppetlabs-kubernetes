...
def replace_networking_v1_namespaced_network_policy(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/networking.k8s.io/v1/namespaces/%{namespace}/networkpolicies/%{name}" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_networking_v1_namespaced_network_policy(params)
