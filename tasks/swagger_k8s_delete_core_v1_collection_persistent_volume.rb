...
def delete_core_v1_collection_persistent_volume(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/api/v1/persistentvolumes" % path_params
...
def task
  ...
  params = $stdin.read
  result = delete_core_v1_collection_persistent_volume(params)
