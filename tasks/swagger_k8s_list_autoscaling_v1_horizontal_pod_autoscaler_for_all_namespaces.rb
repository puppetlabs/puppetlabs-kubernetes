...
def list_autoscaling_v1_horizontal_pod_autoscaler_for_all_namespaces(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/autoscaling/v1/horizontalpodautoscalers" % path_params
...
def task
  ...
  params = $stdin.read
  result = list_autoscaling_v1_horizontal_pod_autoscaler_for_all_namespaces(params)
