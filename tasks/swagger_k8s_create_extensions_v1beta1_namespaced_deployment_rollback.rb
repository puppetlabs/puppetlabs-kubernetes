...
def create_extensions_v1beta1_namespaced_deployment_rollback(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/extensions/v1beta1/namespaces/%{namespace}/deployments/%{name}/rollback" % path_params
...
def task
  ...
  params = $stdin.read
  result = create_extensions_v1beta1_namespaced_deployment_rollback(params)
