...
def delete_core_v1_collection_namespaced_pod_template(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/api/v1/namespaces/%{namespace}/podtemplates" % path_params
...
def task
  ...
  params = $stdin.read
  result = delete_core_v1_collection_namespaced_pod_template(params)
