...
def replace_core_v1_namespaced_replication_controller_scale(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/api/v1/namespaces/%{namespace}/replicationcontrollers/%{name}/scale" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_core_v1_namespaced_replication_controller_scale(params)
