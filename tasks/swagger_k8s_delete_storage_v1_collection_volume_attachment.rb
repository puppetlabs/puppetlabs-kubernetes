...
def delete_storage_v1_collection_volume_attachment(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/storage.k8s.io/v1/volumeattachments" % path_params
...
def task
  ...
  params = $stdin.read
  result = delete_storage_v1_collection_volume_attachment(params)
