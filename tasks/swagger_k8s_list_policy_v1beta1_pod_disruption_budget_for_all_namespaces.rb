...
def list_policy_v1beta1_pod_disruption_budget_for_all_namespaces(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/policy/v1beta1/poddisruptionbudgets" % path_params
...
def task
  ...
  params = $stdin.read
  result = list_policy_v1beta1_pod_disruption_budget_for_all_namespaces(params)
