...
def get_authorization_v1_api_resources(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/authorization.k8s.io/v1/" % path_params
...
def task
  ...
  params = $stdin.read
  result = get_authorization_v1_api_resources(params)
