...
def replace_rbac_authorization_v1beta1_cluster_role_binding(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/rbac.authorization.k8s.io/v1beta1/clusterrolebindings/%{name}" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_rbac_authorization_v1beta1_cluster_role_binding(params)
