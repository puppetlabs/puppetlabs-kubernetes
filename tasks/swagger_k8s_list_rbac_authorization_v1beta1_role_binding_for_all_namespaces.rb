...
def list_rbac_authorization_v1beta1_role_binding_for_all_namespaces(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/rbac.authorization.k8s.io/v1beta1/rolebindings" % path_params
...
def task
  ...
  params = $stdin.read
  result = list_rbac_authorization_v1beta1_role_binding_for_all_namespaces(params)
