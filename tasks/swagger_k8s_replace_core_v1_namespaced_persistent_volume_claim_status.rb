...
def replace_core_v1_namespaced_persistent_volume_claim_status(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/api/v1/namespaces/%{namespace}/persistentvolumeclaims/%{name}/status" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_core_v1_namespaced_persistent_volume_claim_status(params)
