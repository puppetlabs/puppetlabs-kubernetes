...
def get_auditregistration_api_group(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/auditregistration.k8s.io/" % path_params
...
def task
  ...
  params = $stdin.read
  result = get_auditregistration_api_group(params)
