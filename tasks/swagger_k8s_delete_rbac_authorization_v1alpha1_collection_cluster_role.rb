...
def delete_rbac_authorization_v1alpha1_collection_cluster_role(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles" % path_params
...
def task
  ...
  params = $stdin.read
  result = delete_rbac_authorization_v1alpha1_collection_cluster_role(params)
