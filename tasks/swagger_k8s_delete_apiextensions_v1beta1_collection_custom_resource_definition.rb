...
def delete_apiextensions_v1beta1_collection_custom_resource_definition(*args)
  header_params = {}
...
def task
  ...
  params = $stdin.read
  result = delete_apiextensions_v1beta1_collection_custom_resource_definition(params)
