...
def replace_storage_v1_volume_attachment_status(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/storage.k8s.io/v1/volumeattachments/%{name}/status" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_storage_v1_volume_attachment_status(params)
