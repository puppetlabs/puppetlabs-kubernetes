...
def delete_node_v1beta1_collection_runtime_class(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/node.k8s.io/v1beta1/runtimeclasses" % path_params
...
def format_params(key_values)
  ...
  op_params = [
    ...
    op_param('handler', 'body', 'handler', 'handler'),
...
def task
  ...
  params = $stdin.read
  result = delete_node_v1beta1_collection_runtime_class(params)
