...
def replace_apps_v1beta1_namespaced_deployment_scale(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/apps/v1beta1/namespaces/%{namespace}/deployments/%{name}/scale" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_apps_v1beta1_namespaced_deployment_scale(params)
