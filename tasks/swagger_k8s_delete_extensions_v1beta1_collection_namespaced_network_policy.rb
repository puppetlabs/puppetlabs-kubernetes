...
def delete_extensions_v1beta1_collection_namespaced_network_policy(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/extensions/v1beta1/namespaces/%{namespace}/networkpolicies" % path_params
...
def task
  ...
  params = $stdin.read
  result = delete_extensions_v1beta1_collection_namespaced_network_policy(params)
