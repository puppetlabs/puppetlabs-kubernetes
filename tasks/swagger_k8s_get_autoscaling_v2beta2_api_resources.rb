...
def get_autoscaling_v2beta2_api_resources(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/autoscaling/v2beta2/" % path_params
...
def task
  ...
  params = $stdin.read
  result = get_autoscaling_v2beta2_api_resources(params)
