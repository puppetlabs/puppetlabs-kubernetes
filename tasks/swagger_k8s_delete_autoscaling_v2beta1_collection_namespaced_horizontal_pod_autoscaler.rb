...
def delete_autoscaling_v2beta1_collection_namespaced_horizontal_pod_autoscaler(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/autoscaling/v2beta1/namespaces/%{namespace}/horizontalpodautoscalers" % path_params
...
def task
  ...
  params = $stdin.read
  result = delete_autoscaling_v2beta1_collection_namespaced_horizontal_pod_autoscaler(params)
