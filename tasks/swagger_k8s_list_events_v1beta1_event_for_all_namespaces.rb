...
def list_events_v1beta1_event_for_all_namespaces(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/events.k8s.io/v1beta1/events" % path_params
...
def task
  ...
  params = $stdin.read
  result = list_events_v1beta1_event_for_all_namespaces(params)
