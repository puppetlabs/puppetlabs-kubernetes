...
def delete_coordination_v1_collection_namespaced_lease(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/coordination.k8s.io/v1/namespaces/%{namespace}/leases" % path_params
...
def task
  ...
  params = $stdin.read
  result = delete_coordination_v1_collection_namespaced_lease(params)
