...
def replace_apps_v1_namespaced_daemon_set(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/apps/v1/namespaces/%{namespace}/daemonsets/%{name}" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_apps_v1_namespaced_daemon_set(params)
