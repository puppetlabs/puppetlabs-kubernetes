...
def list_apps_v1beta2_replica_set_for_all_namespaces(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/apps/v1beta2/replicasets" % path_params
...
def task
  ...
  params = $stdin.read
  result = list_apps_v1beta2_replica_set_for_all_namespaces(params)
