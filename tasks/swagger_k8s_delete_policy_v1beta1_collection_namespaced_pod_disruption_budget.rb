...
def delete_policy_v1beta1_collection_namespaced_pod_disruption_budget(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/policy/v1beta1/namespaces/%{namespace}/poddisruptionbudgets" % path_params
...
def task
  ...
  params = $stdin.read
  result = delete_policy_v1beta1_collection_namespaced_pod_disruption_budget(params)
