...
def list_rbac_authorization_v1alpha1_role_for_all_namespaces(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/rbac.authorization.k8s.io/v1alpha1/roles" % path_params
...
def task
  ...
  params = $stdin.read
  result = list_rbac_authorization_v1alpha1_role_for_all_namespaces(params)
