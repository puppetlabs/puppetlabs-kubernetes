...
def replace_autoscaling_v2beta1_namespaced_horizontal_pod_autoscaler(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/autoscaling/v2beta1/namespaces/%{namespace}/horizontalpodautoscalers/%{name}" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_autoscaling_v2beta1_namespaced_horizontal_pod_autoscaler(params)
