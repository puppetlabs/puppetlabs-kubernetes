...
def delete_apps_v1beta2_collection_namespaced_controller_revision(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/apps/v1beta2/namespaces/%{namespace}/controllerrevisions" % path_params
...
def format_params(key_values)
  ...
  op_params = [
    ...
    op_param('revision', 'body', 'revision', 'revision'),
...
def task
  ...
  params = $stdin.read
  result = delete_apps_v1beta2_collection_namespaced_controller_revision(params)
