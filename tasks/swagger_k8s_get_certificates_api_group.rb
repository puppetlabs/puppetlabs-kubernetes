...
def get_certificates_api_group(*args)
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/certificates.k8s.io/" % path_params
...
def format_params(key_values)
  ...
  op_params = [
    op_param('groupversion', 'body', 'group_version', 'groupversion'),
...
def task
  ...
  params = $stdin.read
  result = get_certificates_api_group(params)
