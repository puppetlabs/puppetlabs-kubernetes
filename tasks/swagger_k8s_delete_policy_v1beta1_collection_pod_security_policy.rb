...
def delete_policy_v1beta1_collection_pod_security_policy(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/policy/v1beta1/podsecuritypolicies" % path_params
...
def task
  ...
  params = $stdin.read
  result = delete_policy_v1beta1_collection_pod_security_policy(params)
