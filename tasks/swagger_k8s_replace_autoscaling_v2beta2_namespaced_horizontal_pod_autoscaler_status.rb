...
def replace_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler_status(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/autoscaling/v2beta2/namespaces/%{namespace}/horizontalpodautoscalers/%{name}/status" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_autoscaling_v2beta2_namespaced_horizontal_pod_autoscaler_status(params)
