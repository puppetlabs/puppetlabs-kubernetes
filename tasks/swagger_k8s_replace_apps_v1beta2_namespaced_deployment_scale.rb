...
def replace_apps_v1beta2_namespaced_deployment_scale(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/apps/v1beta2/namespaces/%{namespace}/deployments/%{name}/scale" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_apps_v1beta2_namespaced_deployment_scale(params)
