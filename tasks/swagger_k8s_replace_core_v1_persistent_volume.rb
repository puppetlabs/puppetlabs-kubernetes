...
def replace_core_v1_persistent_volume(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/api/v1/persistentvolumes/%{name}" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_core_v1_persistent_volume(params)
