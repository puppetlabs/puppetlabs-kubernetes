...
def list_networking_v1beta1_ingress_for_all_namespaces(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/networking.k8s.io/v1beta1/ingresses" % path_params
...
def task
  ...
  params = $stdin.read
  result = list_networking_v1beta1_ingress_for_all_namespaces(params)
