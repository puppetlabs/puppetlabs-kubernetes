...
def read_admissionregistration_v1beta1_mutating_webhook_configuration(*args)
  header_params = {}
...
def task
  ...
  params = $stdin.read
  result = read_admissionregistration_v1beta1_mutating_webhook_configuration(params)
