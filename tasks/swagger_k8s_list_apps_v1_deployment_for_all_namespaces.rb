...
def list_apps_v1_deployment_for_all_namespaces(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/apps/v1/deployments" % path_params
...
def task
  ...
  params = $stdin.read
  result = list_apps_v1_deployment_for_all_namespaces(params)
