...
def list_extensions_v1beta1_deployment_for_all_namespaces(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/extensions/v1beta1/deployments" % path_params
...
def task
  ...
  params = $stdin.read
  result = list_extensions_v1beta1_deployment_for_all_namespaces(params)
