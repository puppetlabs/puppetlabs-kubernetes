...
def delete_settings_v1alpha1_collection_namespaced_pod_preset(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/settings.k8s.io/v1alpha1/namespaces/%{namespace}/podpresets" % path_params
...
def task
  ...
  params = $stdin.read
  result = delete_settings_v1alpha1_collection_namespaced_pod_preset(params)
