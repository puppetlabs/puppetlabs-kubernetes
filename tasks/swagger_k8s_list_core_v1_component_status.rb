...
def list_core_v1_component_status(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/api/v1/componentstatuses" % path_params
...
def format_params(key_values)
  ...
  op_params = [
    ...
    op_param('conditions', 'body', 'conditions', 'conditions'),
...
def task
  ...
  params = $stdin.read
  result = list_core_v1_component_status(params)
