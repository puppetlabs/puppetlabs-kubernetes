...
def replace_admissionregistration_v1beta1_mutating_webhook_configuration(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/admissionregistration.k8s.io/v1beta1/mutatingwebhookconfigurations/%{name}" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_admissionregistration_v1beta1_mutating_webhook_configuration(params)
