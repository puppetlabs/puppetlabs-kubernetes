...
def delete_batch_v1_collection_namespaced_job(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/batch/v1/namespaces/%{namespace}/jobs" % path_params
...
def task
  ...
  params = $stdin.read
  result = delete_batch_v1_collection_namespaced_job(params)
