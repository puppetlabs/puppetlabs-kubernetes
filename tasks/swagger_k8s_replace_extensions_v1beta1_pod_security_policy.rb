...
def replace_extensions_v1beta1_pod_security_policy(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/extensions/v1beta1/podsecuritypolicies/%{name}" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_extensions_v1beta1_pod_security_policy(params)
