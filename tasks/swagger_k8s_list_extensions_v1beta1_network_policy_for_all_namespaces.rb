...
def list_extensions_v1beta1_network_policy_for_all_namespaces(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/extensions/v1beta1/networkpolicies" % path_params
...
def task
  ...
  params = $stdin.read
  result = list_extensions_v1beta1_network_policy_for_all_namespaces(params)
