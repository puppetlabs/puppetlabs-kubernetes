...
def replace_extensions_v1beta1_namespaced_deployment(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/extensions/v1beta1/namespaces/%{namespace}/deployments/%{name}" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_extensions_v1beta1_namespaced_deployment(params)
