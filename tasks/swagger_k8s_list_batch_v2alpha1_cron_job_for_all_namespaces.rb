...
def list_batch_v2alpha1_cron_job_for_all_namespaces(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/batch/v2alpha1/cronjobs" % path_params
...
def task
  ...
  params = $stdin.read
  result = list_batch_v2alpha1_cron_job_for_all_namespaces(params)
