...
def create_authorization_v1beta1_self_subject_rules_review(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/authorization.k8s.io/v1beta1/selfsubjectrulesreviews" % path_params
...
def task
  ...
  params = $stdin.read
  result = create_authorization_v1beta1_self_subject_rules_review(params)
