...
def delete_rbac_authorization_v1beta1_collection_namespaced_role(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/rbac.authorization.k8s.io/v1beta1/namespaces/%{namespace}/roles" % path_params
...
def task
  ...
  params = $stdin.read
  result = delete_rbac_authorization_v1beta1_collection_namespaced_role(params)
