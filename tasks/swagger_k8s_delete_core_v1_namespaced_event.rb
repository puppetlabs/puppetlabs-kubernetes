...
def delete_core_v1_namespaced_event(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/api/v1/namespaces/%{namespace}/events/%{name}" % path_params
...
def task
  ...
  params = STDIN.read
  result = delete_core_v1_namespaced_event(params)
