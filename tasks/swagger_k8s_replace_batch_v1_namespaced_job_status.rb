...
def replace_batch_v1_namespaced_job_status(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/batch/v1/namespaces/%{namespace}/jobs/%{name}/status" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_batch_v1_namespaced_job_status(params)
