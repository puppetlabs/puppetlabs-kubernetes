...
def replace_storage_v1alpha1_volume_attachment(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/storage.k8s.io/v1alpha1/volumeattachments/%{name}" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_storage_v1alpha1_volume_attachment(params)
