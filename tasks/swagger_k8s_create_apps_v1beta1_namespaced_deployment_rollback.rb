...
def create_apps_v1beta1_namespaced_deployment_rollback(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/apps/v1beta1/namespaces/%{namespace}/deployments/%{name}/rollback" % path_params
...
def task
  ...
  params = $stdin.read
  result = create_apps_v1beta1_namespaced_deployment_rollback(params)
