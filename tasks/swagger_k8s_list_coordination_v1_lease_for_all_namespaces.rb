...
def list_coordination_v1_lease_for_all_namespaces(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/coordination.k8s.io/v1/leases" % path_params
...
def task
  ...
  params = $stdin.read
  result = list_coordination_v1_lease_for_all_namespaces(params)
