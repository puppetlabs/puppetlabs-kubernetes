...
def replace_coordination_v1_namespaced_lease(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/coordination.k8s.io/v1/namespaces/%{namespace}/leases/%{name}" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_coordination_v1_namespaced_lease(params)
