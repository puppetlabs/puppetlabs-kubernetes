...
def delete_apps_v1beta2_collection_namespaced_daemon_set(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/apps/v1beta2/namespaces/%{namespace}/daemonsets" % path_params
...
def task
  ...
  params = $stdin.read
  result = delete_apps_v1beta2_collection_namespaced_daemon_set(params)
