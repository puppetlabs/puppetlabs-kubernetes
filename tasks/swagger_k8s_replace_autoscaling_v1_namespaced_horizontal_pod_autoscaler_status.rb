...
def replace_autoscaling_v1_namespaced_horizontal_pod_autoscaler_status(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/autoscaling/v1/namespaces/%{namespace}/horizontalpodautoscalers/%{name}/status" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_autoscaling_v1_namespaced_horizontal_pod_autoscaler_status(params)
