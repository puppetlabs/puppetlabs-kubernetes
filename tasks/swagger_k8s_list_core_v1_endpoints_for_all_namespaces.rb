...
def list_core_v1_endpoints_for_all_namespaces(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/api/v1/endpoints" % path_params
...
def task
  ...
  params = $stdin.read
  result = list_core_v1_endpoints_for_all_namespaces(params)
