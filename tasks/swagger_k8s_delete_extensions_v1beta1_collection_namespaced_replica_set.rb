...
def delete_extensions_v1beta1_collection_namespaced_replica_set(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/extensions/v1beta1/namespaces/%{namespace}/replicasets" % path_params
...
def task
  ...
  params = $stdin.read
  result = delete_extensions_v1beta1_collection_namespaced_replica_set(params)
