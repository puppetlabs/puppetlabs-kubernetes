...
def list_apps_v1beta1_controller_revision_for_all_namespaces(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/apps/v1beta1/controllerrevisions" % path_params
...
def task
  ...
  params = $stdin.read
  result = list_apps_v1beta1_controller_revision_for_all_namespaces(params)
