...
def delete_core_v1_collection_namespaced_config_map(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/api/v1/namespaces/%{namespace}/configmaps" % path_params
...
def format_params(key_values)
  ...
  op_params = [
    ...
    op_param('binarydata', 'body', 'binarydata', 'binarydata'),
...
def task
  ...
  params = $stdin.read
  result = delete_core_v1_collection_namespaced_config_map(params)
