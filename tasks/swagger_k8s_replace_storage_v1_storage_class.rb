...
def replace_storage_v1_storage_class(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/storage.k8s.io/v1/storageclasses/%{name}" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_storage_v1_storage_class(params)
