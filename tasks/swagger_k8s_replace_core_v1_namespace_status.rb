...
def replace_core_v1_namespace_status(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/api/v1/namespaces/%{name}/status" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_core_v1_namespace_status(params)
