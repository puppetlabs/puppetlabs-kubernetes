...
def list_apps_v1beta2_deployment_for_all_namespaces(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/apps/v1beta2/deployments" % path_params
...
def task
  ...
  params = $stdin.read
  result = list_apps_v1beta2_deployment_for_all_namespaces(params)
