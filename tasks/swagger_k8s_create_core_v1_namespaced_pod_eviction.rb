...
def create_core_v1_namespaced_pod_eviction(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/api/v1/namespaces/%{namespace}/pods/%{name}/eviction" % path_params
...
def format_params(key_values)
  ...
  op_params = [
    ...
    op_param('deleteoptions', 'body', 'delete_options', 'deleteoptions'),
...
def task
  ...
  params = $stdin.read
  result = create_core_v1_namespaced_pod_eviction(params)
