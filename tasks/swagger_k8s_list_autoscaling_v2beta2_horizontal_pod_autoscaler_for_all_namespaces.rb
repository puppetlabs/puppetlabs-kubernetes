...
def list_autoscaling_v2beta2_horizontal_pod_autoscaler_for_all_namespaces(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/autoscaling/v2beta2/horizontalpodautoscalers" % path_params
...
def task
  ...
  params = $stdin.read
  result = list_autoscaling_v2beta2_horizontal_pod_autoscaler_for_all_namespaces(params)
