...
def replace_rbac_authorization_v1alpha1_cluster_role(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/rbac.authorization.k8s.io/v1alpha1/clusterroles/%{name}" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_rbac_authorization_v1alpha1_cluster_role(params)
