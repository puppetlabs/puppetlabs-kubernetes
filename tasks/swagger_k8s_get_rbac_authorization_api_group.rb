...
def get_rbac_authorization_api_group(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/rbac.authorization.k8s.io/" % path_params
...
def task
  ...
  params = $stdin.read
  result = get_rbac_authorization_api_group(params)
