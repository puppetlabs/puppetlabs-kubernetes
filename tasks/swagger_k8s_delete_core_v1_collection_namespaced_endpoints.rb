...
def delete_core_v1_collection_namespaced_endpoints(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/api/v1/namespaces/%{namespace}/endpoints" % path_params
...
def format_params(key_values)
  ...
  op_params = [
    ...
    op_param('subsets', 'body', 'subsets', 'subsets'),
...
def task
  ...
  params = $stdin.read
  result = delete_core_v1_collection_namespaced_endpoints(params)
