...
def create_authentication_v1_token_review(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/authentication.k8s.io/v1/tokenreviews" % path_params
...
def task
  ...
  params = $stdin.read
  result = create_authentication_v1_token_review(params)
