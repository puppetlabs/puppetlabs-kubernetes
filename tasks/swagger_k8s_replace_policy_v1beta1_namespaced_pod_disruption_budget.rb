...
def replace_policy_v1beta1_namespaced_pod_disruption_budget(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/policy/v1beta1/namespaces/%{namespace}/poddisruptionbudgets/%{name}" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_policy_v1beta1_namespaced_pod_disruption_budget(params)
