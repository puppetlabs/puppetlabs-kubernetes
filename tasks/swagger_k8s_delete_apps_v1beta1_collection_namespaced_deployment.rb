...
def delete_apps_v1beta1_collection_namespaced_deployment(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/apps/v1beta1/namespaces/%{namespace}/deployments" % path_params
...
def task
  ...
  params = $stdin.read
  result = delete_apps_v1beta1_collection_namespaced_deployment(params)
