...
def replace_core_v1_namespaced_config_map(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/api/v1/namespaces/%{namespace}/configmaps/%{name}" % path_params
...
def format_params(key_values)
  ...
  op_params = [
    ...
    op_param('binarydata', 'body', 'binary_data', 'binarydata'),
...
def task
  ...
  params = $stdin.read
  result = replace_core_v1_namespaced_config_map(params)
