...
def get_rbac_authorization_v1_api_resources(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/rbac.authorization.k8s.io/v1/" % path_params
...
def task
  ...
  params = $stdin.read
  result = get_rbac_authorization_v1_api_resources(params)
