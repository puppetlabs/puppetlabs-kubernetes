...
def list_core_v1_limit_range_for_all_namespaces(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/api/v1/limitranges" % path_params
...
def task
  ...
  params = $stdin.read
  result = list_core_v1_limit_range_for_all_namespaces(params)
