...
def replace_settings_v1alpha1_namespaced_pod_preset(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/settings.k8s.io/v1alpha1/namespaces/%{namespace}/podpresets/%{name}" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_settings_v1alpha1_namespaced_pod_preset(params)
