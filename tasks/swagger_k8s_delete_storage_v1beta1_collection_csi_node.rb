...
def delete_storage_v1beta1_collection_csi_node(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/storage.k8s.io/v1beta1/csinodes" % path_params
...
def task
  ...
  params = $stdin.read
  result = delete_storage_v1beta1_collection_csi_node(params)
