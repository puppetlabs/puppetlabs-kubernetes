...
def replace_events_v1beta1_namespaced_event(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/events.k8s.io/v1beta1/namespaces/%{namespace}/events/%{name}" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_events_v1beta1_namespaced_event(params)
