...
def list_apps_v1_replica_set_for_all_namespaces(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/apps/v1/replicasets" % path_params
...
def task
  ...
  params = $stdin.read
  result = list_apps_v1_replica_set_for_all_namespaces(params)
