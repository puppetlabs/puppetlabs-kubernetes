...
def replace_extensions_v1beta1_namespaced_replication_controller_dummy_scale(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/extensions/v1beta1/namespaces/%{namespace}/replicationcontrollers/%{name}/scale" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_extensions_v1beta1_namespaced_replication_controller_dummy_scale(params)
