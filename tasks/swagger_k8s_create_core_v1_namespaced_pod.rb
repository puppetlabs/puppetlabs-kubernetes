...
def create_core_v1_namespaced_pod(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/api/v1/namespaces/%{namespace}/pods" % path_params
...
def task
  ...
  params = $stdin.read
  result = create_core_v1_namespaced_pod(params)
