...
def replace_node_v1alpha1_runtime_class(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/node.k8s.io/v1alpha1/runtimeclasses/%{name}" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_node_v1alpha1_runtime_class(params)
