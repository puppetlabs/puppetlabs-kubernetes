...
def delete_batch_v2alpha1_collection_namespaced_cron_job(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/batch/v2alpha1/namespaces/%{namespace}/cronjobs" % path_params
...
def task
  ...
  params = $stdin.read
  result = delete_batch_v2alpha1_collection_namespaced_cron_job(params)
