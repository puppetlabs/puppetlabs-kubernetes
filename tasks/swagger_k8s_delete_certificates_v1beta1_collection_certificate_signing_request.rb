...
def delete_certificates_v1beta1_collection_certificate_signing_request(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/certificates.k8s.io/v1beta1/certificatesigningrequests" % path_params
...
def task
  ...
  params = $stdin.read
  result = delete_certificates_v1beta1_collection_certificate_signing_request(params)
