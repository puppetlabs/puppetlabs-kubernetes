...
def replace_apps_v1beta2_namespaced_stateful_set(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/apps/v1beta2/namespaces/%{namespace}/statefulsets/%{name}" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_apps_v1beta2_namespaced_stateful_set(params)
