...
def delete_node_v1beta1_runtime_class(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/node.k8s.io/v1beta1/runtimeclasses/%{name}" % path_params
...
def task
  ...
  params = $stdin.read
  result = delete_node_v1beta1_runtime_class(params)
