...
def replace_apiextensions_v1beta1_custom_resource_definition_status(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/apiextensions.k8s.io/v1beta1/customresourcedefinitions/%{name}/status" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_apiextensions_v1beta1_custom_resource_definition_status(params)
