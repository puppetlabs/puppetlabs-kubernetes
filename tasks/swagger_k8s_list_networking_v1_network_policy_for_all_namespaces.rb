...
def list_networking_v1_network_policy_for_all_namespaces(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/networking.k8s.io/v1/networkpolicies" % path_params
...
def task
  ...
  params = $stdin.read
  result = list_networking_v1_network_policy_for_all_namespaces(params)
