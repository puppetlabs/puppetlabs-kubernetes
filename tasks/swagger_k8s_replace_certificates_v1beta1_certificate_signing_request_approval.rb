...
def replace_certificates_v1beta1_certificate_signing_request_approval(*args)
  header_params = {}
  ...
  uri_string = "#{arg_hash['kube_api']}/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/%{name}/approval" % path_params
...
def task
  ...
  params = $stdin.read
  result = replace_certificates_v1beta1_certificate_signing_request_approval(params)
